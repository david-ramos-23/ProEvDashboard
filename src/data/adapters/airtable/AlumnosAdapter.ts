...
function mapToAlumno(record: AirtableRecord<AirtableAlumnoFields>): Alumno {
  ...
  return {
    ...
    resumenFeedbackIA: (() => { const v = f['Resumen Feedback Video (AI)']; return typeof v === 'string' ? v : (v && typeof v === 'object' && 'value' in v ? String((v as Record<string, unknown>).value) : undefined); })(),
    siguienteAccionIA: (() => { const v = f['Siguiente Accion Recomendada (AI)']; return typeof v === 'string' ? v : (v && typeof v === 'object' && 'value' in v ? String((v as Record<string, unknown>).value) : undefined); })(),
